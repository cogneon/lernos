...
rm -rf $filename.*
rm -rf ../docs/en/*
rm -ff ../docs/en-slides/index.html
...
pandoc --from markdown -s --resource-path="./src" -t revealjs -V theme=night -s ./slides/index.md -o ../docs/en-slides/index.html
