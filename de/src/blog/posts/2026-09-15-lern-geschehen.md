...
Mit dabei sind auch [Christian Kaiser](https://www.linkedin.com/in/christian-kaiser-datev/) und ich aus der lernOS Community mit einem **Workshop** mit dem Titel **"Peer Learning: mit lernOS Circles das formelle Lernen in Unternehmen erweitern"**. Wir werden in einem Impuls aufzeigen, wie bestehende Lernarchitekturen in Organisationen um Elemente des informellen Lernens (speziell Peer Learning) erweitert werden können. Dabei teilen wir Erfahrungen aus Learning Circle Experiences (z.B. [DATEV Learning Circle Experiences](https://www.datev.de/web/de/berufsgruppenuebergreifend/veranstaltungen/weitere-veranstaltungen/learning-circle-experience), nächster Start am 21. September 2026) mit Hunderten Learning Circles und stellen die Ergebnisse einer Umfrage zu Erfolgsfaktoren aus dem Frühjahr 2026 vor. Mit dem **Rabattcode "LG-SIMON"** erhaltet ihr 20% Rabatt [beim Ticketkauf](https://lern-geschehen.de/#tickets).

![Social Card zum Workshop von Simon Dückert und Christian Kaiser auf dem Lern geschehen Summit 2026](./images/2026-09-15-lern-geschehen.jpeg)
